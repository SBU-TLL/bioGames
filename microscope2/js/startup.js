...
function loadTutorial() {
    ...
    var stepText = [{
            ...
            "steps": [{
                    ...
                    "shortText": "Stage",
                    "longText": "",
                    "feedbackText": "Lower the stage all the way to the bottom by rotating the coarse focus knob.",
                    "logic": function () {
                        setupEnableStage();
                        ms.enableCoarseKnob();
            ...
            },
                {
                    ...
                    "completeSettings": function () {
                        ms.caliperBlade = 25;
                        console.log("ms.caliperBlade = ", ms.caliperBlade)
                        ms.update();
                        console.log("ms.diopterPosition = ", ms.diopterPosition)
                        console.log("ms = ", ms)
                    }
...

        {
            ...
            "steps": [{
                    ...
                    "id": "setupAperture",
                    "shortText": "Aperture",
                    "longText": "Placeholder for 10x Aperture step",
                    "feedbackText": "Drag the aperture",
                    "logic": function () {
                        medAdjustAperture();
                    }
            }, {
...
function createGame(stepText) {
    ...
    for (i in stepText) {
        ...
        for (j in stepText[i].steps) {
            ...
            stepCount++;
            var newStep = new Step(cur.id, cur.shortText, cur.longText, cur.feedback, "#step" + stepCount, "#icon" + stepCount, cur.logic || {}, cur.completeSettings || {});
