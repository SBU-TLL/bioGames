...
class StateMachine {
    ...
    update() {
        ...
        //this.translateReduceSVG("#caliperMetal", 0, this.yknobcaliper);
        this.translateReduceSVG("#ycaliper", this.ycaliper / 2.8, this.ycaliper);
        this.translateReduceSVG("#xcaliper", this.xcaliper, 0);
        this.translateReduceSVG("#caliperMetal", this.xcaliper, this.ycaliper);
    ...
    enableSideDiaphragmRotate() {
        ...
        var callback = function (rotation) {
            ...
            console.log("this.diaphragmHeightPosition = ", this.diaphragmHeightPosition);

            this.diaphragmHeightPosition = (rotation * 70);
            if (this.diaphragmHeightPosition <= 0) {
                this.diaphragmHeightPosition = 0;
            } else if (this.diaphragmHeightPosition >= 25) {
                this.diaphragmHeightPosition = 25;
            }

            this.update();
            subHandler(ms.diaphragmHeightPosition, 0, 4.8, setupCondense, id, null);
        };
        //registerKnob(id, Directions.VERTICAL, callback, 0.25);
