...
class StateMachine {
    constructor() {
        ...
        this.sideSlideStates = ["#sideSlide1", "#sideSlide2", "#sideSlide3", "#sideSlide4", "#sideSlide5", "#sideSlide6", "#sideSlide7", "#sideSlide8", "#sideSlide9", "#sideSlide10", "#sideSlide11", "#sideSlide12"];
    ...
    enableCaliper() {
        ...
        function addCaliperXDrag(part) {
            registerKnob(part, Directions.HORIZONTAL, function (rotation) {
                ...
                if (ms.xcaliper > -10 && ms.xcaliper < 10 && ms.ycaliper >= 16 && ms.ycaliper <= 22) {
